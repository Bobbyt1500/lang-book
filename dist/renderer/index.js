...
const quiz_1 = __webpack_require__(4);
...
const LanguageBlockRow = ({ data }) => {
    return ((0, jsx_runtime_1.jsx)("div", { class: "block-row", children: data.map((blockData, i) => {
            return (0, jsx_runtime_1.jsx)(Block, { data: blockData, vocab: data.length === 1 });
        }) }));
};
class App extends preact.Component {
    ...
    render() {
        return ((0, jsx_runtime_1.jsxs)("div", { children: [this.props.data.map((rowData, i) => {
                    return (0, jsx_runtime_1.jsx)(LanguageBlockRow, { data: rowData });
...
const Question = ({ data, prompt, answers, showAnswers }) => {
    return ((0, jsx_runtime_1.jsx)("div", { class: "question", children: data.map((block, i) => {
            ...
            return ((0, jsx_runtime_1.jsxs)("div", { class: "question-block", children: [(0, jsx_runtime_1.jsxs)("div", { class: "block", children: [block.pronunciation && (0, jsx_runtime_1.jsx)("span", { class: "tooltip question-tooltip", children: block.pronunciation }), (0, jsx_runtime_1.jsx)("span", { onClick: () => {
...
/* harmony export */ });
/* harmony import */ var _v1_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(28);
